"""
Django settings for maquila_proyecto project.
...
SECRET_KEY = 'django-insecure-(w*7lc+)f#j@ou%jt!_gpwm7_(&9jf3ajah-5ka81br#y75fuk'
...
ROOT_URLCONF = 'maquila_proyecto.urls'
...
WSGI_APPLICATION = 'maquila_proyecto.wsgi.application'
